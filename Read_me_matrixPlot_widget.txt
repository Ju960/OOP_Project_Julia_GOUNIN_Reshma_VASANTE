READ ME MATRIXPLOT_WIDGET

The goal of this file is to show a dynamic matrix with the widget.

We are chosen to use the package widget to displate a dynamic matrix, taking markers genes and genes as parameters.
...
How to use the file _matrixPlot_widge.py ?
